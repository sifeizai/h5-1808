            ...
            function pinjie(goods){
                ...
                for(let i=0;i<goods.length;i++){
                    ...
                    <li class="mbshop_listPdCon" data-icon="" data-site="">
                        <a href="../html/detail.html?id=${goods[i].id}" id="mbshop_listPdImg" target="_blank">
                            <img src="${goods[i].url}" style="display: block;width: 230px;height: 315px;" >
                        </a>
                        <a class="mbshop_listPdCon_tag" target="_blank" href="../html/detail.html?id=${goods[i].id}"><em>1件7折</em></a>
                                <span class="mbshop_listPdText fl goodlist_brandname">
                                    <a href="../html/detail.html?id=${goods[i].id}" target="_blank">${goods[i].banner_name}</a>
                                    <label class="goodlist_discount">${goods[i].zhekou}折</label>
                                </span> 
                        <span class="mbshop_listPdText fl"><a href="../html/detail.html?id=${goods[i].id}" target="_blank">${goods[i].names}</a></span> 
                            ...
                            <div class="mbshop_listPdColorScroll">
                                <div class="mbshop_listPdColor">
                                    <input type="hidden" value="#">
                                        <a href="../html/detail.html?id=${goods[i].id}"><img src="${goods[i].color1}" alt=""></a>
                                        <a href="../html/detail.html?id=${goods[i].id}"><img src="${goods[i].color2}" alt=""></a>
                                        <a href="../html/detail.html?id=${goods[i].id}"><img src="${goods[i].color3}" alt=""></a>
                                </div>
